...
def build_detection_semisup_train_loader(cfg, mapper=None):
    ...
    logger.info("BSNumber of training samples " + str(len(dataset)))
...
def build_detection_train_loader_DG(cfg, mapper=None):  # TODO update
    ...
    if sampler_name == "TrainingSampler":
        ...
        raise ValueError("Unknown training sampler: {}".format(sampler_name))
    return build_batch_data_loader_DG(
...
def build_batch_data_loader_DG(  # TODO
        dataset,
        sampler,
