...
from adapteacher.data.build import (
    ...
    build_detection_train_loader_DG,
)

from adapteacher.data.dataset_mapper import DatasetMapperDG
...
class ATeacherTrainer(DefaultTrainer):
    ...
    def run_step_full_semisup(self):
        ...
        # (1) get features for labeled-data , unlabeled-data
        # (2) if labeled train model with labeled
        # (3) for unlabeled (1) get the pseudo labels then train hahah hahahaah hahahah hahaah hahahah hahahaah
    ...
    def _update_teacher_model(self, keep_rate=0.9996):
        ...
        self.model_teacher.roi_heads.load_state_dict(new_teacher_dict)
